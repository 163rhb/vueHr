<template>
        ...
        <div style="display: flex ;justify-content: space-between">
            <div>
                ...
                <el-button  @click="searchEmps"  icon="el-icon-search" :disabled="showAdvanceSearchView" type="primary" style="margin-top: 8px ;margin-left: 8px">搜索</el-button>
            ...
            <div>
                ...
                <el-button  @click="ShowAddEmpDialog" icon="el-icon-plus" type="primary">添加员工</el-button>
            </div>
        </div>
            ...
            <div v-show="showAdvanceSearchView"
                ...
                <el-row style="margin-top: 10px">
                    ...
                    <el-col :span="5" :offset="4">
                        <el-button size="mini" @click="closeAdvancedSe">取消</el-button>
                ...
                <el-table
                    ...
                    <el-table-column
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button  @click="delEmp(scope.row)" style="padding: 3px" size="mini" type="danger">删除
                            </el-button>
                        </template>
                    </el-table-column>
                </el-table>
        ...
        methods:{
            ...
            delEmp(data){
                this.$confirm('此操作将永久删除【' + data.name + '】该部门, 是否继续?', '提示', {
                    ...
                    this.deleteRequst("/emp/basic/"+data.id).then(resp=>{
                        if(resp)
                        {
                            this.initEmps()
                        }
            ...
            addEmp(){
                if(this.emp.id)
                {
                    this.$refs['empForm'].validate(valid=>{
                        if(valid){
                            this.$confirm('确定更改员工信息？ ', '提示', {
                                confirmButtonText: '确定',
                                cancelButtonText: '取消',
                                type: 'warning',
                                center: true
                            }).then(() => {
                                this.putRequst("/emp/basic/",this.emp).then(resp=>{
                                    if(resp)
                                    {
                    ...
                    this.$refs['empForm'].validate(valid=>{
                        if(valid){
                            this.postRequst("/emp/basic/",this.emp).then(resp=>{
                                if(resp)
                                {
                                    this.dialogVisible=false
                                    this.initEmps()
            ...
            getMaxWorkId(){
                this.getRequst("/emp/basic/getMaxWorkId/").then(resp=>{
                    if(resp)
                    {
            ...
            initPosition(){
                if(!window.sessionStorage.getItem("positions")){
                    this.getRequst("/emp/basic/getAllPositions/").then(resp=>{
                        this.positions=resp
                    })
            ...
            initData(){
                if(!window.sessionStorage.getItem("nations")){
                    this.getRequst("/emp/basic/getAllNations/").then(resp=>{
                        this.nations=resp
                    })
                }
                else {
                ...
                if(!window.sessionStorage.getItem("joplevels")){
                    this.getRequst("/emp/basic/getAllJopLevels/").then(resp=>{
                        this.joblevels=resp
                    })
                }
                else {
                ...
                if(!window.sessionStorage.getItem("politicsstatus")){
                    this.getRequst("/emp/basic/getALLPoliticsStatus/").then(resp=>{
                ...
                if (!window.sessionStorage.getItem("deps")) {
                    this.getRequst('/emp/basic/deps/').then(resp => {
                        if (resp) {
                            this.allDeps = resp;
